...
```{r}
# Feature Scaling
training_set_LDA[-34] = scale(training_set_LDA[-34])
test_set_LDA[34] = scale(test_set_LDA[34])
...
```{r}
library(MASS)
lda = lda(formula = fraud_reported ~ ., data = training_set)
...
preprocessParams <- preProcess(autinsurance_COPY, method=c("center", "scale", "ica"), n.comp=2)
# summarize transform parameters
print(preprocessParams)
# transform the dataset using the parameters
transformed <- predict(preprocessParams, autinsuranceNum)
